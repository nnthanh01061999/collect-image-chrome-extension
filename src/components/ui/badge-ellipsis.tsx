    ...
    return (
        <>
            <div
                ref={showRef}
                className={cn(
                    'grid w-full grid-flow-col items-center justify-start gap-1 overflow-hidden',
                    className,
                )}
                {...props}
            >
                {content.map((item) => (
                    <Badge
                        ...
                        variant='secondary'
                        onClose={
                            item.value === EllipsisTag ? undefined : onClose
                        }
                        value={item.value}
                        {...badgeProps}
                    >
            ...
            <div
                ref={hideRef}
                className={cn(
                    'absolute left-0 top-0 -z-10 grid w-full grid-flow-col items-center justify-start gap-1 overflow-hidden px-2 opacity-0',
                    className,
                )}
                {...props}
                style={{
